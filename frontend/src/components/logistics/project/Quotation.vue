<template>
    <div>
      ...
      <div class="page-info">
        ...
        <span v-if="this.checkPermissions.validatePermission(this.allPermissions.add_logisticsquoteitem, this.$store.getters.getPermissions) && this.projectData.logistics_bidding">
          This project is open for quoting and vendors are able to submit their quote items.
        </span>
        <span v-else>Please wait to be requested to submit your quote items.</span>
      </div>

      <div class="content-data m-b-20" v-if="this.checkPermissions.validatePermission(this.allPermissions.change_project, this.$store.getters.getPermissions)">
        <div class="pad-15">
      ...
      <div class="m-b-20 m-l-20">
        <Row :gutter="8" v-if="this.checkPermissions.validatePermission(this.allPermissions.add_logisticsquoteitem, this.$store.getters.getPermissions)">
          ...
          <i-col span="8" v-if="bidExists || !bidExists && this.projectData.logistics_bidding" class="content-area-two">
...
export default {
  ...
  methods: {
    ...
    fetchQuotes (offset) {
      ...
      this.api['viewLgQuotes']('get', params, null, null).then(res => {
        let data = res.data
    ...
    fetchQuoteItems (offset) {
      ...
      this.api['viewLgQuoteItems']('get', params, null, null).then(res => {
        let data = res.data
    ...
    requestQuotation () {
      ...
      this.api['viewLgQuotes']('post', null, formData).then(res => {
        this.$notify({
          group: 'success',
          type: 'success',
    ...
    updateQuoteStatus (slug, quoteStatus) {
      ...
      this.api['viewLgQuoteItem'](this.selectedQuoteItem.slug, 'put', null, this.selectedQuoteItem).then(res => {
        this.$notify({
          group: 'success',
          type: 'success',
