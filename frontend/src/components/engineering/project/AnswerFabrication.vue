<template>
    <div>
      ...
      <div class="bottom-header">
        <h1>
          <span class="text">Clear fabrication</span>
        </h1>
        <div class="left-links">
            <div class="buttons">
              <div class="button-group m-r-5">
                <button v-if="!surveyFilled" class="btn gray">Complete the survey first</button>
                <button v-if="surveyFilled && selectedCivil.fabrication_status === 'Ongoing'" class="btn green" @click="newCivil= true">Clear fabrication</button>
                <button v-if="surveyFilled && selectedCivil.civil_status !== 'Active'" class="btn gray">Fabrication already cleared</button>
                <Modal
                  v-model="newCivil"
                  ok-text="Clear"
                  width="400"
                  ...
                  <p>You are about to clear this fabrication.</p>
                </Modal>
                <Modal
      ...
      <div class="content-data">
        <Table :columns="columns" :data="questions"></Table>
      </div>
...
export default {
  ...
  methods: {
    ...
    fetchCivil () {
      this.api['viewFabrication'](this.$route.params.fabrication_slug, 'get', null, null).then(res => {
