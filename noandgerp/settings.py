"""
Django settings for noandgerp project.
...
SECRET_KEY = ')b1q)x31w2mwz5+zn3m(o%*q#a@_m+an$r55@ahs-uf7&$6*p5'
...
WSGI_APPLICATION = 'noandgerp.wsgi.application'
